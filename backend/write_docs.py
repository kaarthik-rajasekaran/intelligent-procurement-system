...
def generate_docs():
    output_path = r"d:\MICRO-HACK\FINAL_SYSTEM_DOCUMENTATION.md"
    
    sections = []
    
    # Header & Abstract
    sections.append("""# Intelligent Procurement Management System (IPMS)
...
""")
    ...
    # Section 1
    sections.append("""# 1. Project Overview & Problem Statement
...
""")
    ...
    # Section 2
    sections.append("""# 2. System Architecture & Intelligence Separation
...
""")
    ...
    # Section 3 & 4
    sections.append("""# 3. Technology Stack & Implementation Details
...
""")
    ...
    # Section 5 & 6
    sections.append("""# 5. Complete Step-by-Step Procurement Lifecycle
...
""")
    ...
    # Section 7, 8, 9
    sections.append("""# 6. Database Schema & Entity Relationships
...
""")
    ...
    print(f"Successfully generated complete documentation at: {output_path}")
